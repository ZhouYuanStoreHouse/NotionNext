...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ZZZY', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '享受什么', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xxxx.com', // 网站地址
